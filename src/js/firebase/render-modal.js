  ...
  if (type === 'logIn') {
    ...
    `<p class="registration__title">${titleString}</p>
      <label class="registration__fild">
        ...
        <input type="email" class="registration__input" name="email" required placeholder="email@address.com" data-action-${type}/>
      ...
      <label class="registration__fild">
        ...
        <input type="password" class="registration__input" name="password" required placeholder="(A-Z, a-z, 0-9, !@_-  min 6 symbols)" data-action-${type}/>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"class="registration__icon">
